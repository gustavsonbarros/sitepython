...
def usuarios():
    if logado == True:
        arquivo = []
        for documento in os.listdir('/home/gustavson-barros/Área de trabalho/sitepython/arquivos'):
...
def upload():
    ...
    arquivo.save(os.path.join('/home/gustavson-barros/Área de trabalho/sitepython/arquivos', nome_arquivo))
